        ...
        <div class="row">
            <div class="col-lg-5 col-md-6 mb-4">
                <div class="about-us-footer" style="max-width: 440px;">
                    ...
                    <p class="text-white mb-4" style="opacity: 0.8; line-height: 1.6;">
                        At James Douglas, we connect exceptional leadership talent with forward-thinking companies through tailored executive search solutions driven by insight, precision, and impact.
                    </p>
                </div>
                <div class="d-flex gap-2">
                    <a href="https://www.linkedin.com/company/jamesdouglas/about/?viewAsMember=true" class="text-white" style="opacity: 0.7;">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2">
                        <a href=".././careers/" class="text-white text-decoration-none" style="opacity: 0.8;">Career</a>
                    </li>
                    <li class="mb-2">
                    ...
                    <li class="mb-2">
                        <a href="../candidates.html" class="text-white text-decoration-none" style="opacity: 0.8;">Candidates</a>
                    </li> -->
                </ul>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                ...
                <div class="mb-3">
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <p class="text-white mb-0" style="opacity: 0.8;">+91 74001 60679</p>
                    </div>
                </div>
                <div class="mb-4">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-center">
                <div class="d-flex flex-wrap justify-content-md-end gap-3">
                    <a href="../privacy-policy.html" class="text-white text-decoration-none" style="opacity: 0.6;">Privacy Policy</a>
                    <a href="../terms-of-service.html" class="text-white text-decoration-none" style="opacity: 0.6;">Terms of Service</a>
                    <a href="../cookie-policy.html" class="text-white text-decoration-none" style="opacity: 0.6;">Cookie Policy</a>
                </div>
            </div>
        </div>
    </div>
